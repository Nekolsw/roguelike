...
namespace XYZRoguelike
{
	SwordMan::SwordMan()
	{
		...
		gameObject = XYZEngine::GameWorld::Instance()->CreateGameObject("SwordMan");
		...
		movement->SetTarget(XYZEngine::GameWorld::Instance()->GetGameObjectByName("SwordMan"));
	...
	SwordMan::SwordMan(const XYZEngine::Vector2Df position)
	{
		gameObject = XYZEngine::GameWorld::Instance()->CreateGameObject("SwordMan");
		auto playerRenderer = gameObject->AddComponent<XYZEngine::SpriteRendererComponent>();
	...
	std::shared_ptr<XYZEngine::GameObject> SwordMan::GetGameObject()
	{
		return gameObject;
	}
}